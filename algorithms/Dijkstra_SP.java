...
/**
 * ***********************************************************************
 * Compilation: javac Dijkstra_SP.java Execution: java Dijkstra_SP input.txt s
 ...
 * are nonnegative.
 *
 * % java Dijkstra_SP tinyEWD.txt 0 0 to 0 (0.00) 0 to 1 (1.05) 0->4 0.38 4->5
 ...
 *
 * % java Dijkstra_SP mediumEWD.txt 0 0 to 0 (0.00) 0 to 1 (0.71) 0->44 0.06
 ...
 */
/**
 * The <tt>Dijkstra_SP</tt> class represents a data type for solving the
...
public class Dijkstra_SP {
     ...
     * - 1
     */
    public Dijkstra_SP(EdgeWeightedDigraph G, int s) {
    ...
    /**
     * Unit tests the <tt>Dijkstra_SP</tt> data type.
     */
    public static void main(String[] args) {
        ...
        Dijkstra_SP sp = new Dijkstra_SP(G, s);
    ...
    /**
     * The <tt>Dijkstra_AllPairs_SP</tt> class represents a data type for solving
     * the all-pairs shortest paths problem in edge-weighted digraphs where the
     * edge weights are nonnegative.
     * <p>
     * This implementation runs Dijkstra's algorithm from each vertex. The
     * constructor takes time proportional to <em>V</em> (<em>E</em> log
     * <em>V</em>) and uses space proprtional to <em>V</em><sup>2</sup>, where
     * <em>V</em> is the number of vertices and <em>E</em> is the number of
     * edges. Afterwards, the <tt>dist()</tt> and <tt>hasPath()</tt> methods
     * take constant time and the <tt>path()</tt> method takes time proportional
     * to the number of edges in the shortest path returned.
     * <p>
     * For additional documentation, see <a href="/algs4/44sp">Section 4.4</a>
     * of
     * <i>Algorithms, 4th Edition</i> by Robert Sedgewick and Kevin Wayne.
     *
     * @author Robert Sedgewick
     * @author Kevin Wayne
     */
    public class Dijkstra_AllPairs_SP {
         ...
         * <tt>V</tt> - 1
         */
        public Dijkstra_AllPairs_SP(EdgeWeightedDigraph G) {
        ...
        /**
         * Returns the length of a shortest path from vertex <tt>s</tt> to
         * vertex <tt>t</tt>.
         *
         * @param s the source vertex
         * @param t the destination vertex
         * @return the length of a shortest path from vertex <tt>s</tt> to
         * vertex <tt>t</tt>;
         * <tt>Double.POSITIVE_INFINITY</tt> if no such path
         */
